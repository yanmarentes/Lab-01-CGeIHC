...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, 230 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));

		modelaux = model;
		model = glm::scale(model, glm::vec3(8.0f, 3.0f, 2.0f));
		...
		//Llantas
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(2.0f, 4.5f, -1.58f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, 1.0f));//Hace que rote alrededor del brazo
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 1.0f, 0.4f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.0f, 4.5f, -1.58f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f));//Hace que rote alrededor del brazo
		model = glm::rotate(model, 270 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(2.0f, 4.5f, -4.42f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, 0.0f, 1.0f));//Hace que rote alrededor del brazo
		model = glm::rotate(model, 270 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.0f, 4.5f, -4.42f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(0.0f, 0.0f, 1.0f));//Hace que rote alrededor del brazo
		model = glm::rotate(model, 270 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));//Hace que rote alrededor del brazo
		modelaux = model;
