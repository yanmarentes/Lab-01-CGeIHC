...
#include <stdio.h>
#include <string.h>
#include<cmath> //librería mat de funciones 
#include<vector>
#include <glew.h>
#include <glfw3.h>
//glm
#include<glm.hpp>
//librería para usar las matrices de transformación
...
void CreaPiramide()
{
	...
	GLfloat vertices[] = {
		-1.0f, -0.5f,0.0f,	//0 Vértice inf. izq.
		1.0f,-0.5f,0.0f,	//1	Vértice inf. der.
		0.0f,0.3f, -0.25f,	//2 Vértice superior
		0.0f,-0.5f,-0.5f,	//3
...
void CreaCopa1()
{
	...
	GLfloat vertices[] = {
		-0.3f, -0.5f,0.0f,	//0 Vértice inf. izq.
		0.3f,-0.5f,0.0f,	//1	Vértice inf. der.
		0.0f,0.5f, -0.25f,	//2 Vértice superior
		0.0f,-0.5f,-0.5f,	//3
...
int main()
{
	...
	//Es una aproximación a la vista humana, solo maneja un ángulo de visión 

	//Model: Matriz de Dimensión 4x4 en la cual se almacena la multiplicación de las transformaciones geométricas.
	glm::mat4 model(1.0); //fuera del while se usa para inicializar la matriz con una identidad, es la matriz de modelo donde se guarda los valores de proyección y escala
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f));//Es importante porque z positivo apunta a la pantalla, se recomienda que tenga una traslación y se almacena en la matriz 4x4
		//
		...
		//Inicializar matriz de dimensión 4x4 que servirá como matriz de modelo para almacenar las transformaciones geométricas
		model = glm::mat4(1.0);//es una matriz de 4x4 que se multiplica con otra igua, si se pone antes de la traslación, rota alrededor del origen, si
		//Se pone después, rota en su propio centro
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[1]->RenderMesh();//Se dibuja el cubo de un color que no está declarado y está más cerca o encimado sobre el triangulo
